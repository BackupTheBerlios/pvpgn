...
/* BlacKDicK 04/04/2003
ADDED Support for 4x4 (to make FFA work properly) and AT 3x3*/
...
static bn_byte const anongame_maps[] = {
		0x0B ,0x4D ,0x61 ,0x70 ,0x73 ,0x5C ,0x46 ,0x72 ,0x6F ,0x7A 
		...
		,0x78 ,0x00 ,0x4D ,0x61 ,0x70 ,0x73 ,0x5C ,0x46 ,0x72 ,0x6F 
		,0x7A ,0x65 ,0x6E ,0x54 ,0x68 ,0x72 ,0x6F ,0x6E ,0x65 ,0x5C 
		,0x42 ,0x65 ,0x74 ,0x61 ,0x5C ,0x28 ,0x38 ,0x29 ,0x47 ,0x61 
		,0x72 ,0x64 ,0x65 ,0x6E ,0x4F ,0x66 ,0x57 ,0x61 ,0x72 ,0x2E 
		,0x77 ,0x33 ,0x78 ,0x00 
};
*/
...
static bn_byte const anongame_type[] = {
		0x02 ,0x00 ,0x05 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x06 ,0x00 
		,0x01 ,0x02 ,0x03 ,0x04 ,0x05 ,0x01 ,0x00 ,0x00 ,0x00 ,0x00 
		,0x06 ,0x04 ,0x05 ,0x06 ,0x07 ,0x08 ,0x09 ,0x02 ,0x00 ,0x00 
		,0x00 ,0x00 ,0x03 ,0x07 ,0x08 ,0x09 ,0x03 ,0x00 ,0x00 ,0x00
		,0x00 ,0x01 ,0x0A ,0x04 ,0x00 ,0x00 ,0x00 ,0x00 ,0x06 ,0x04
		,0x05 ,0x06 ,0x07 ,0x08 ,0x09 ,0x01 ,0x02 ,0x00 ,0x00 ,0x00
		,0x00 ,0x02 ,0x06 ,0x04 ,0x05 ,0x06 ,0x07 ,0x08 ,0x09 ,0x01
		,0x00 ,0x00 ,0x00 ,0x02 ,0x03 ,0x07 ,0x08 ,0x09
};
*/
...
static bn_byte const anongame_desc[] = {
		0x07 ,0x00 ,0x00 ,0x4F ,0x6E ,0x65 ,0x20 ,0x76 ,0x73 ,0x2E 
		...
		, 
...
static int _client_findanongame(t_connection * c, t_packet const * const packet)
{
   ...
   if (bn_byte_get(packet->u.client_findanongame.option)==CLIENT_FINDANONGAME_PROFILE)
	...
	if (bn_int_get(packet->u.client_findanongame_inforeq.count) > 1) {
		...
		char anongame_PG_1v1_prefix[]  = {0x00, 0x00, 0x00, 0x00, 0x00};
		char anongame_PG_2v2_prefix[]  = {0x01, 0x00, 0x00, 0x00, 0x00};
		char anongame_PG_3v3_prefix[]  = {0x02, 0x00, 0x00, 0x00, 0x00};
		char anongame_PG_4v4_prefix[]  = {0x03, 0x00, 0x00, 0x00, 0x00};
		char anongame_PG_sffa_prefix[] = {0x04, 0x00, 0x00, 0x00, 0x00};

		char anongame_AT_2v2_prefix[]  = {0x00, 0x00, 0x00, 0x00, 0x02};
		...
		char anongame_begin_PG_section = 0x00;
		char anongame_begin_AT_section = 0x01;
		...
		for (i=0;i<bn_byte_get(packet->u.client_findanongame_inforeq.noitems);i++){
			...
			case CLIENT_FINDANONGAME_INFOTAG_MAP:
				...
				//FIXME: make this adding of mapnames to packet a nice function ?
				if ((mapslist = anongame_get_w3xp_maplist(ANONGAME_TYPE_1V1)))
				{
				...
				if ((mapslist = anongame_get_w3xp_maplist(ANONGAME_TYPE_2V2)))
				{
				  LIST_TRAVERSE(mapslist, curr)
				  {
				    if ((mapname = (char *)elem_get_data(curr)))
				...
				if ((mapslist = anongame_get_w3xp_maplist(ANONGAME_TYPE_3V3)))
				{
				  LIST_TRAVERSE(mapslist, curr)
				  {
				    if ((mapname = (char *)elem_get_data(curr)))
				...
				if ((mapslist = anongame_get_w3xp_maplist(ANONGAME_TYPE_4V4)))
				{
				  LIST_TRAVERSE(mapslist, curr)
				  {
				    if ((mapname = (char *)elem_get_data(curr)))
				...
				if ((mapslist = anongame_get_w3xp_maplist(ANONGAME_TYPE_SMALL_FFA)))
				{
				  LIST_TRAVERSE(mapslist, curr)
				  {
				    if ((mapname = (char *)elem_get_data(curr)))
			...
			case CLIENT_FINDANONGAME_INFOTAG_TYPE:
				...
				packet_append_data(rpacket, &anongame_begin_PG_section,1);
				...
				packet_append_data(rpacket,&anongame_begin_AT_section,1);
				AT_gamestyles = 1;
