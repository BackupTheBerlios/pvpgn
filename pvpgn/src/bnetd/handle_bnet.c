...
static bn_byte const anongame_type[] = {
		0x02 ,0x00 ,0x04 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x06 ,0x00 
		...
		,0x00 ,0x06 ,0x04 ,0x05 ,0x06 ,0x07 ,0x08 ,0x09 ,0x01 ,0x02 
		,0x00 ,0x00 ,0x00 ,0x00 ,0x02 ,0x06 ,0x04 ,0x05 ,0x06 ,0x07 
		,0x08 ,0x09 ,0x03 ,0x00 ,0x00 ,0x00 ,0x00 ,0x01 ,0x07
...
static bn_byte const anongame_desc[] = {
		0x05 ,0x00 ,0x00 ,0x4F ,0x6E ,0x65 ,0x20 ,0x76 ,0x73 ,0x2E 
		...
		, 
};
...
static int _client_findanongame(t_connection * c, t_packet const * const packet)
{
   ...
   if (bn_byte_get(packet->u.client_findanongame.option)==CLIENT_FINDANONGAME_PROFILE)
	...
	if (bn_int_get(packet->u.client_findanongame_inforeq.count) > 1) {
		...
		char anongame_PG_sffa_prefix[] = {0x03, 0x00, 0x00, 0x00, 0x00};
		...
		mapscount_total = mapscount_1v1 + mapscount_2v2 + mapscount_3v3 + mapscount_sffa;
