...
extern unsigned int prefs_get_max_concurrent_logins(void) PURE_ATTR();

/* ADDED BY UNDYING SOULZZ 4/9/02 */
extern unsigned int prefs_get_identify_timeout_secs(void) PURE_ATTR();
extern char const * prefs_get_server_info(void) PURE_ATTR();

/* [zap-zero] 20020616 */
extern char const * prefs_get_mysql_host(void) PURE_ATTR();
extern char const * prefs_get_mysql_account(void) PURE_ATTR();
extern char const * prefs_get_mysql_password(void) PURE_ATTR();
extern char const * prefs_get_mysql_sock(void) PURE_ATTR();
extern char const * prefs_get_mysql_dbname(void) PURE_ATTR();
extern unsigned int prefs_get_mysql_persistent(void) PURE_ATTR();

extern char const * prefs_get_mapsfile(void) PURE_ATTR();
...
//URL
extern char const * prefs_get_w3xp_matchmaking_server_url(void) PURE_ATTR();
extern char const * prefs_get_w3xp_matchmaking_player_url(void) PURE_ATTR();
extern char const * prefs_get_w3xp_matchmaking_tourney_url(void) PURE_ATTR();

//LADR
extern char const * prefs_get_w3xp_matchmaking_solo_url(void) PURE_ATTR();
extern char const * prefs_get_w3xp_matchmaking_solo_url_desc(void) PURE_ATTR();

extern char const * prefs_get_w3xp_matchmaking_2vs2_url(void) PURE_ATTR();
extern char const * prefs_get_w3xp_matchmaking_2vs2_url_desc(void) PURE_ATTR();

extern char const * prefs_get_w3xp_matchmaking_3vs3_url(void) PURE_ATTR();
extern char const * prefs_get_w3xp_matchmaking_3vs3_url_desc(void) PURE_ATTR();

extern char const * prefs_get_w3xp_matchmaking_4vs4_url(void) PURE_ATTR();
extern char const * prefs_get_w3xp_matchmaking_4vs4_url_desc(void) PURE_ATTR();

extern char const * prefs_get_w3xp_matchmaking_team_url(void) PURE_ATTR();
extern char const * prefs_get_w3xp_matchmaking_team_url_desc(void) PURE_ATTR();
