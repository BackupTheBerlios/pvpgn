...
<body bgcolor="#FFFFFF">
<p align="center"><a href="index.php?action=submit">Submit news</a> | <a href="index.php?action=edit">Edit news</a> | <a href="index.php?action=newuser">Create new user</a> | <a href="links.php">Edit links</a> | <a href="index.php?action=downloads">Edit downloads</a> | <a href="index.php?action=logout">Logout</a></p>
<p>
<?php
if (isset($_GET['edit'])) {
